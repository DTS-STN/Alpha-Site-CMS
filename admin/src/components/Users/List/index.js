      ...
      <Wrapper withHigherHeight={!data.length}>
        <Table
          ...
          rowLinks={[
            {
              icon: canUpdate
                ? <CustomFontAwesomeIcon icon={faPencilAlt} ariaLabel={formatMessage({id: 'Settings.roles.form.permissions.update'})}/>
                : null,
              onClick: data => {
                handleClick(data.id);
              },
            ...
            {
              icon: canDelete
                ? <CustomFontAwesomeIcon icon={faTrashAlt} ariaLabel={formatMessage({id: 'Settings.roles.form.permissions.delete'})} />
                : null,
              onClick: data => {
