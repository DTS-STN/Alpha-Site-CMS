...
import IconLinks from '../../../../../../../../admin/src/components/CustomBuffet/IconLinks';
  ...
  const links = [
    {
      ...
      ariaLabel: formatMessage({id: 'Settings.roles.form.permissions.duplicate'})
    },
    {
      ...
      ariaLabel: formatMessage({id: 'Settings.roles.form.permissions.update'})
    },
    {
      ...
      ariaLabel: formatMessage({id: 'Settings.roles.form.permissions.delete'})
    },
  ].filter(icon => icon);
